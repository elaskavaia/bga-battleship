 ...
 * stats.inc.php
 *
 * BattleShip game statistics description
 *
 */
/*
 ...
 * Statistics ID is the reference used by BGA website. If you change the ID, you lost all historical statistic data. Do
 * NOT re-use an ID of a deleted statistic
